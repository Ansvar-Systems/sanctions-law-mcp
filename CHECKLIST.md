...
- [ ] Update `name` to `@ansvar/sanctions-law-mcp`
- [ ] Update `description`
...
git remote add origin git@github.com:Ansvar-Systems/sanctions-law-mcp.git
...
- [ ] Create directory `servers/sanctions-law-mcp/`
- [ ] Create `server.yaml`:
  ```yaml
