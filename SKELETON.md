...
cp -r skeleton/ ../sanctions-law-mcp/
cd ../sanctions-law-mcp/

# Or use degit for a clean copy
npx degit ansvar-systems/eu-regulations-mcp/skeleton sanctions-law-mcp
```
...
mkdir @ansvar/sanctions-law-mcp
cd @ansvar/sanctions-law-mcp
npm init -y
...
```json
{
  ...
  "main": "dist/index.js",
  "bin": {
    "sanctions-law-mcp": "dist/index.js"
  },
  "files": [
    "dist",
    "data/database.db"
  ...
  "repository": {
    "type": "git",
    "url": "https://github.com/Ansvar-Systems/sanctions-law-mcp"
  },
...
metadata:
  author: Ansvar Systems AB
  license: Apache-2.0
  homepage: https://github.com/Ansvar-Systems/sanctions-law-mcp
  tags:
    - compliance
    - legal
    - ansvar
